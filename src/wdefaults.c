...
static void init_wdefaults(void)
{
	...
	ANoTiling = WMCreatePLString("NoTiling");
			    ...
			    Bool useGlobalDefault)
{
	...
	value = get_value(dw, dc, dn, da, ANoTiling, No, useGlobalDefault);
	APPLY_VAL(value, no_tiling, ANoTiling);
